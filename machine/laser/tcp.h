...
#define S0_TX_RD   0x0422      // Socket 0: Tx Read Pointer Register: 0x0422 to 0x04230
...
#define S0_RX_RD   0x0428      // Socket 0: Rx Read Pointer: 0x0428 to 0x0429100
...
#define TCP_PORT         100      // TCP/IP Port
void PWM_init();
